      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-3 sm:py-4">
          ...
          <nav className="hidden lg:flex items-center space-x-6 xl:space-x-8">
            ...
            <button onClick={() => scrollToSection('clients')} className="text-gray-700 hover:text-orange-600 font-medium transition-all duration-200 hover:scale-105 text-sm xl:text-base">
              Clients
            </button>
        ...
        {isOpen && (
          <div className="lg:hidden border-t border-orange-100 bg-white/95 backdrop-blur-md">
            <div className="px-2 pt-2 pb-4 space-y-1">
              ...
              <button onClick={() => scrollToSection('clients')} className="block w-full text-left px-4 py-3 text-gray-700 hover:text-orange-600 hover:bg-orange-50 rounded-xl transition-all duration-200 text-base font-medium">
                Clients
              </button>
